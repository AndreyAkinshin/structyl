...
The `--continue` flag has been removed. Using it results in an error. For continue-on-error workflows, use `continue_on_error: true` in CI pipeline step definitions (see [CI Integration](ci-integration.md)).
:::
