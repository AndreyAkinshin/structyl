...
// Deprecated: This is a legacy fallback. The canonical source of truth is
// internal/cli/toolchains_template.json. Use GetDefaultToolchains() for
// the complete toolchain configuration including mise settings.
