...
// builtinToolchains contains all built-in toolchain presets.
var builtinToolchains = map[string]*Toolchain{
	...
	"poetry": {
		...
		Commands: map[string]interface{}{
			...
			"check:fix":     "poetry run ruff format .",
			"bench":         nil,
			"pack":          "poetry build",
			"doc":           nil,
	...
	"bundler": {
		...
		Commands: map[string]interface{}{
			...
			"check":         []interface{}{"bundle exec rubocop", "bundle exec rubocop --format offenses --fail-level convention"},
