...
func TestDetect(t *testing.T) {
	...
	tests := []struct {
		...
		{"dotnet sln", []string{"MyProject.sln"}, "dotnet", true},
		{"dotnet Directory.Build.props", []string{"Directory.Build.props"}, "dotnet", true},
		{"dotnet global.json", []string{"global.json"}, "dotnet", true},
